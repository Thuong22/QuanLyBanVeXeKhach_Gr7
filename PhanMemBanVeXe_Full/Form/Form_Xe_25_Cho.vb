...
Public Class Form_Xe_25_Cho
    ...
    Private Sub Form_Xe_25_Cho_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Duyet_danh_sach_cho_ngoi()
        ...
        Try
            ...
            While dr.Read = True
                For i As Integer = 0 To grb_25.Controls.Count - 1
                    If dr.GetValue(2).ToString = grb_25.Controls(i).Text Then
                        CType(grb_25.Controls(i), DevComponents.DotNetBar.ButtonX).Image = My.Resources.hanh_khach
                    End If
                Next
            End While
            connect.Close()
