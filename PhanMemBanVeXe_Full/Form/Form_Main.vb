...
#End Region
    ...
    Private Sub txt_SoDTHanhKhach_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_SoDTHanhKhach.KeyPress
    ...
    Private Sub txt_SoDienThoai_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_SoDienThoai.KeyPress
        'If (e.KeyChar.ToString = ".") And (txt_SoDienThoai.Text.Contains(e.KeyChar.ToString)) Then
        '    e.Handled = False
        If Asc(e.KeyChar) <> 8 Then
                If Asc(e.KeyChar) < 48 Or Asc(e.KeyChar) > 57 Then
                    e.Handled = True
