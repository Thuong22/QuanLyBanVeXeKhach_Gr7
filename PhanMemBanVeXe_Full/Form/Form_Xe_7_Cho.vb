...
Public Class Form_Xe_7_Cho
    ...
    Private Sub Duyet_danh_sach_cho_ngoi()
        ...
        Try
            ...
            While dr.Read = True
                For i As Integer = 0 To grb_7.Controls.Count - 1
                    If dr.GetValue(2).ToString = grb_7.Controls(i).Text Then
                        CType(grb_7.Controls(i), DevComponents.DotNetBar.ButtonX).Image = My.Resources.hanh_khach
                    End If
                Next
            End While
            connect.Close()
    ...
    Private Sub Form_Xe_7_Cho_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
