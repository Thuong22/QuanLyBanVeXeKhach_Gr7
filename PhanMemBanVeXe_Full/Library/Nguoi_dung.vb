...
Class Nguoi_dung
    ...
    Public Sub UpdateNguoiDung()
        ...
        Else
            ...
            Form_Main.Button_Sua.Enabled = True
            Form_Main.Button_Xoa.Enabled = False
            Form_Main.Button_CapPass.Enabled = False
            Form_Main.Button_Luu.Enabled = False
            Form_Main.Button_Huy.Enabled = False
        End If
    End Sub
    ...
    Public Sub Luu_thay_doi()
        ...
        With Form_Main
            If flag = True Then 'Them nguoi dung moi
                If TestInfo() Then
                    Dim dg As DialogResult = MessageBox.Show("Ban có chắn chắc muốn thêm người dùng này không, " & vbNewLine &
                    ...
                    If dg = Windows.Forms.DialogResult.OK Then
                        ...
                        If flag = 0 Then
                            ...
                            End Try
                        End If
                        Form_Main.Button_Huy.PerformClick()
                    Else
                        Huy_thao_tac()
                    End If
            ...
            Else 'Sua thong tin nguoi dung
                If TestInfo() Then
                    If Form_Login.LoginLoaiND <> "Admin" And Form_Main.cbo_Username.Text <> Form_Login.LoginTenND Then
                        Dim dg As DialogResult = MessageBox.Show("Ban chỉ có quyền sưa thông tin cá nhân của mình, " & vbNewLine &
                    ...
                    Dim dialog As DialogResult = MessageBox.Show("Ban có chắn chắc muốn sửa thông tin cá nhân., " & vbNewLine &
                                "Click OK đê đồng ý, Cancel để hủy.", "Thông báo", MessageBoxButtons.OKCancel, MessageBoxIcon.Question)
