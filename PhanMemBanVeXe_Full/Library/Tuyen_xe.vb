                ...
                If TestInfo() Then
                    ...
                    If dg = Windows.Forms.DialogResult.OK Then
                        ...
                        If flag = 0 Then
                            ...
                            lenh &= " Values ('" + .cbo_IdTuyen.Text + "', N'" + .cbo_TenTuyen.Text + "', N'" + .cbo_DiaDiemDi.Text + "', N'" + .cbo_DiaDiemDen.Text + "')"
            ...
            Else
                ...
                If TestInfo() Then
                    ...
                    If dialog = DialogResult.OK Then
                        lenh = "Update TuyenXe Set TenTuyen = N'" + .cbo_TenTuyen.Text + "', DiaDiemDi = N'" + .cbo_DiaDiemDi.Text + "', DiaDiemDen = N'" + .cbo_DiaDiemDen.Text + "' where IdTuyen = '" + .cbo_IdTuyen.Text + "'"
